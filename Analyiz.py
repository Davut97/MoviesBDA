...
import numpy as np
import datetime
from Utils import get_movies_id, write_array_to_csv
import statistics
import math
...
# data.to_csv("C:/Users/owes4/Desktop/Thıs Wıll Work/TEST.csv", index=False)
 ###########################
 ############################
...
#                   "Eddie Murphy", "Robert Downey, Jr", "Chris Evans", "Chris Hemsworth", "Mark Ruffalo", "Scarlett Johansson",
